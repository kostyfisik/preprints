...
particles and if Fig 2 (e) it is about the same order inside and
between the particles. This way due to relatively small coupling
...
dipole resonance at 637~nm, futhermore, 3D FDTD simulation of such a particle
with a gold substrate (as is was used in the paper) and periodic
boundary condition for a HCP array lead to appearance of a peak at
678~nm in contrast with the simulation presented in Fig. 1(b) of the
paper.  We do not have a good explanation for a such disagreement.
\begin{figure}
  ...
  \caption{Mie simulation for core-shell particle with gold core (a)
    ...
    absorbtion, extinction and backscattering.\label{fig:Au-core-shell}}
\end{figure}
