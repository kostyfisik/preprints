...
new designs. Initially, we set the total amount of the absorbed power
with cross-section of $\alpha_{\rm abs}=\frac{3\lambda^2}{8\pi}$ and
keep the outer radius of the particle. In this case the optimization
...
as material parameters we obtained radii
...
layer vanishes $\{a_{c1},a_{c2}\}=\{0.00635,0.00747\}\lambda$ resulting
