...
cross-section of $\alpha_{\rm abs}=\frac{3\lambda^2}{8\pi}$ and keep
the outer radius the particle our optimization give a similar result
for the structure with contributing harmonics TM${_1}$ and TE$_1$.
For $\epsilon_1 = 1.29+i0.01$, $\epsilon_2 = -10.37+ i0.35$, and
