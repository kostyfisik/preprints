...
% nanoparticles} %KSL
% \title{Super-absorption and efficient absorption of light by
% spherical nanoparticles} %IVS
\title{Super absorption of light by nanoparticles} %AEM
% Proposed reviewers: Anatoly Zayats
% Andrea Alu
% Sergei Bozhevolnyi
...
It is a common understanding that, in general, a bigger particle 
has a bigger absorption cross-section, so sphere with the diameter of
1 cm absorbs more light than any nanoscale sphere. Therefore, it is practical to employ {\em the absorption
efficiency} $Q_{\rm abs}=C_{\rm abs}/\pi R^2$, where $R$ is the outer
radius of the particle and $C_{\rm abs}$ is the absorption
cross-section. 
...
%$\tilde{b}_2$.  Our suggestion is indirectly proven by the reduced
...
\begin{figure}
  \center{
    ...
    \caption{ Amplitude of electric field for $R=36$~nm (a,c) and
      super-absorbing designs (b,d) in E-k  (a-b) and H-k (c-d)
...
\begin{acknowledgments}
 ...
 AEM and IVS would like to acknowledge support from the Australian Research Council through Future Fellow and Discovery project schemes. 
  ...
  % Science Foundation Grant No. 14-12-01227.
\end{acknowledgments}
